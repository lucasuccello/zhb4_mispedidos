sap.ui.define([
	...
	return BaseController.extend("hb4.zhb4_mispedidos.controller.AgregarInsumo", {
        ...
        getPreciosFuturos: function(){
            ...
            this.getModel("landingMdl").read("/Cultivos('TR')", {
                success: function(oDataReturn, oResponse){
                     oController.simboloTrigo = oDataReturn.simboloPrecioFuturo;
                     oController.precioDefTrigo = oDataReturn.precioFuturoDefault;
                     this.obtenerPrecioFuturoTrigo(oController.simboloTrigo, oController.precioDefTrigo);
                }.bind(this),
            ...
            this.getModel("landingMdl").read("/Cultivos('SO')", {
                success: function(oDataReturn, oResponse){
                     oController.simboloSoja = oDataReturn.simboloPrecioFuturo;
                     oController.precioDefSoja = oDataReturn.precioFuturoDefault;
                     this.obtenerPrecioFuturoSoja(oController.simboloSoja, oController.precioDefSoja);
                }.bind(this),
                error: function(oError){                
                }               
            });
        ...
        obtenerPrecioFuturoSoja: function (simbolo, precioDefault) {
            ...
            this.getView().getModel().read(sPath, {
                success: function (oData) {
                    this._precioFuturoSoja = oData.precio;
                    this.getView().byId("_tileSoja").setValue(this._precioFuturoSoja);
                }.bind(this), 
                error: function (oError) {
                    // poner precio por defecto del cultivo
                    this._precioFuturoSoja = precioDefault;
                    this.getView().byId("_tileSoja").setValue(precioDefault);
                }.bind(this)
            })
        },
        ...
        obtenerPrecioFuturoTrigo: function (simbolo, precioDefault) {
            ...
            this.getView().getModel().read(sPath, {
                success: function (oData) {
                    this._precioFuturoTrigo = oData.precio;
                    this.getView().byId("_tileTrigo").setValue(this._precioFuturoTrigo);
                }.bind(this), 
                error: function (oError) {
                    // poner precio por defecto del cultivo
                    this._precioFuturoTrigo = precioDefault;
                    this.getView().byId("_tileTrigo").setValue(precioDefault);
                }.bind(this)
            })
        },
